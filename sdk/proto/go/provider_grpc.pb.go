...
const (
	...
	ResourceProvider_StreamInvoke_FullMethodName  = "/pulumirpc.ResourceProvider/StreamInvoke"
...
type ResourceProviderClient interface {
	...
	// of responses.
	StreamInvoke(ctx context.Context, in *InvokeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[InvokeResponse], error)
...
func (c *resourceProviderClient) StreamInvoke(ctx context.Context, in *InvokeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[InvokeResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ResourceProvider_ServiceDesc.Streams[0], ResourceProvider_StreamInvoke_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type ResourceProvider_StreamInvokeClient = grpc.ServerStreamingClient[InvokeResponse]
...
type ResourceProviderServer interface {
	...
	// StreamInvoke dynamically executes a built-in function in the provider, which returns a stream
	// of responses.
	StreamInvoke(*InvokeRequest, grpc.ServerStreamingServer[InvokeResponse]) error
	// Call dynamically executes a method in the provider associated with a component resource.
...
func (UnimplementedResourceProviderServer) StreamInvoke(*InvokeRequest, grpc.ServerStreamingServer[InvokeResponse]) error {
...
func RegisterResourceProviderServer(s grpc.ServiceRegistrar, srv ResourceProviderServer) {
	// If the following call pancis, it indicates UnimplementedResourceProviderServer was
...
func _ResourceProvider_StreamInvoke_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ResourceProviderServer).StreamInvoke(m, &grpc.GenericServerStream[InvokeRequest, InvokeResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ResourceProvider_StreamInvokeServer = grpc.ServerStreamingServer[InvokeResponse]

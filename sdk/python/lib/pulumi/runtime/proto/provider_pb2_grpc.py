...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in pulumi/provider_pb2_grpc.py depends on'
...
def add_ResourceProviderServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('pulumirpc.ResourceProvider', rpc_method_handlers)

...
class ConvertProgramRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["args", b"args", "loader_target", b"loader_target", "mapper_target", b"mapper_target", "source_directory", b"source_directory", "target_directory", b"target_directory"]) -> None: ...
